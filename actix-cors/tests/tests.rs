...
async fn test_not_allowed_origin_fn() {
    ...
    {
        let req = TestRequest::default().insert_header(("Origin", "https://www.known.com"))
            .method(Method::GET)
            .to_srv_request();
...
async fn test_allowed_origin_fn() {
    ...
    let req = TestRequest::default().insert_header(("Origin", "https://www.unknown.com"))
        .method(Method::GET)
        .to_srv_request();
...
async fn test_multiple_origins_preflight() {
    ...
    let req = TestRequest::default().insert_header(("Origin", "https://example.com"))
    ...
    let req = TestRequest::default().insert_header(("Origin", "https://example.org"))
        .insert_header((header::ACCESS_CONTROL_REQUEST_METHOD, "GET"))
        .method(Method::OPTIONS)
        .to_srv_request();
...
//async fn test_response() {
    ...
    //let mut cors = Cors::default()
        ...
        //.new_transform(fn_service(|req: ServiceRequest| {
            //ok(req.into_response(HttpResponse::Ok().insert_header((header::VARY, "Accept")).finish()))
        //}))
        //.await
        //.unwrap();
...
async fn validate_origin_allows_all_origins() {
    ...
    let req =
        TestRequest::default().insert_header(("Origin", "https://www.example.com")).to_srv_request();
...
async fn test_allow_any_origin_any_method_any_header() {
    ...
    let req = TestRequest::default().insert_header((header::ACCESS_CONTROL_REQUEST_METHOD, "POST"))
